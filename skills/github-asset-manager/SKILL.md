...
```bash
node scripts/github-asset-manager.js profile [--user <username>] [--refresh] [--email <email>] [--featured-sort stars|recent] [--featured-style static|shields|compact] [--theme <theme>]
```
